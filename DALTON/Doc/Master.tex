...
\hypersetup{
 urlcolor=brown,linkcolor=blue,citecolor=red}
...
\newcommand{\starstarkey}{\quotekw{**}}
\newcommand{\starkey}{\quotekw{*}}
\newcommand{\dotkey}{\quotekw{.}}
%\newcommand{\f}[1]{{"{f#1}" }}  % not used, what was it define for ??
...
\newcommand{\latestrelease}{Dalton2020.1}
...
\bibliography{dalton,dft,Symm_tut,fde,srdft,embedding}
%
% Index
%

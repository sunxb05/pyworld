...
&)
    ...
    subroutine T6(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 13) = 15.0d0 * x11 * (693.0d0 * x2 * x23 * x9 + x20 - 63.0d0 * x23 * x7 - 63.0d0 * x28 * x7 + x30 + x46 - 63.&
&0d0 * x55 * x7)
            ...
            T(i, 19) = 45.0d0 * x16 * zi * (10.0d0 * x30 * x31 + 8.0d0 * x31 * (2.0d0 * x40 - 1.0d0) + 10.0d0 * x59 + 7.0d0 * &
&(5.0d0 * x31 - 1.0d0) * (x44 - 1.0d0))
    ...
    subroutine T7(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 24) = -x14 * (56.0d0 * x36 * x62 + x47 * (21.0d0 * x80 - x84 + 1.0d0) + x83 * (-x35 + 18.0d0 * x62 - x85 + 1.&
&0d0))
            T(i, 25) = -315.0d0 * x25 * (x47 * x84 + x84 * x88 + x86 * x87 + 3.0d0 * (7.0d0 * x34 - 3.0d0) * (11.0d0 * x46 - 3&
&.0d0))
            T(i, 26) = -45.0d0 * x12 * xi * (20.0d0 * x34 * x88 * (7.0d0 * x46 - 1.0d0) + 280.0d0 * x50 * x62 + 160.0d0 * x62 &
                                            &* x86 + x87 * (-12.0d0 * x46 + 16.0d0 * x89 + 1.0d0) + 7.0d0 * (5.0d0 * x34 - 1.0d0) * (x69 - x71 + 1.0d0))
    ...
    subroutine T8(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 31) = x43 * (72.0d0 * x102 * (x66 - 5.0d0) + 4.0d0 * x61 * (66.0d0 * x102 - x66 - 20.0d0 * x77 + 5.0d0) + 3.0&
&d0 * (x87 - 1.0d0) * (x60 - 30.0d0 * x61 + 5.0d0))
            T(i, 32) = x46 * (x134 * (18.0d0 * x102 - x136 - 3.0d0 * x61 + 1.0d0) + x135 * (3.0d0 * x61 - 1.0d0) + x138 * (24.&
&0d0 * x102 - x136 + x83 + 2.0d0) + 3.0d0 * x88 * (-14.0d0 * x61 + 21.0d0 * x96 + 1.0d0))
            T(i, 33) = 315.0d0 * x18 * (224.0d0 * x102 * x139 + 168.0d0 * x102 * x88 + x135 * x142 + x138 * x141 + 3.0d0 * (7.&
&0d0 * x61 - 3.0d0) * (-x108 + x110 + 3.0d0))
            T(i, 34) = 45.0d0 * x20 * (400.0d0 * x139 * x61 * (7.0d0 * x77 - 1.0d0) + 200.0d0 * x141 * x61 + 700.0d0 * x142 * &
&x61 * (3.0d0 * x77 - 1.0d0) + 350.0d0 * x61 * x92 + 80.0d0 * x61 * (x140 - 16.0d0 * x77 + 3.0d0) + 21.0d0 * (5.0d0 * x61 - 1.0&
&d0) * (x110 - x129 + 15.0d0))
    ...
    subroutine T9(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 25) = -x138 * (39.0d0 * x5 - 195.0d0 * x65 + 39.0d0 * x69 - 195.0d0 * x76 + 39.0d0 * x78 + 1105.0d0 * x79 - 1&
&95.0d0 * x82 - 9.0d0)
            ...
            T(i, 39) = -x16 * (x164 * (1144.0d0 * x166 - 660.0d0 * x76 + 60.0d0 * x78 + x95 - x97 - 15.0d0) + x165 * (x126 - 4&
&95.0d0 * x127 + 135.0d0 * x69 - 5.0d0) + 36.0d0 * x76 * x98)
            T(i, 40) = -2835.0d0 * x31 * (36.0d0 * x165 * x69 * (x39 - 5.0d0) + x169 * (x112 + 88.0d0 * x76 - 20.0d0 * x78 + 1&
&0.0d0) + 36.0d0 * x69 * (x40 + 66.0d0 * x76 - 20.0d0 * x78 + 5.0d0) + 11.0d0 * x87 * (33.0d0 * x127 - 30.0d0 * x69 + 5.0d0))
            T(i, 41) = -x84 * (3.0d0 * x117 * (21.0d0 * x127 - 14.0d0 * x69 + 1.0d0) + x169 * (-32.0d0 * x144 + x177 + 240.0d0&
& * x178 + 9.0d0 * x69 - 144.0d0 * x76 - 2.0d0) + 336.0d0 * x170 * x76 * (3.0d0 * x69 - 1.0d0) + x175 * x176 * (-x173 - 3.0d0 *&
& x69 + 18.0d0 * x76 + 1.0d0) + 224.0d0 * x76 * (-x173 - 9.0d0 * x69 + 24.0d0 * x76 + 2.0d0))
            T(i, 42) = -1575.0d0 * x31 * (42.0d0 * x117 * x69 + 84.0d0 * x170 * x184 + 112.0d0 * x175 * x183 * x69 + x176 * x1&
&82 + x180 * x181 + 33.0d0 * (7.0d0 * x69 - 3.0d0) * (-x143 + x145 + 3.0d0))
            T(i, 43) = -675.0d0 * x15 * (84.0d0 * x118 * x76 + 160.0d0 * x180 * x76 + x181 * (-80.0d0 * x144 + 64.0d0 * x159 +&
& x177 - 1.0d0) + 40.0d0 * x182 * x69 * (7.0d0 * x78 - 1.0d0) + 1120.0d0 * x183 * x76 * (3.0d0 * x78 - 1.0d0) + 70.0d0 * x184 *&
& (33.0d0 * x144 - 18.0d0 * x78 + 1.0d0) + 21.0d0 * (5.0d0 * x69 - 1.0d0) * (x106 - x116 + x160 - 1.0d0))
    ...
    subroutine T10(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 13) = x18 * (x101 + x104 + 143.0d0 * x11 - x28 * x90 + x28 * x96 - x39 * x90 - x74 * x95 - x77 * x91 + x88 + &
&x89 + x92 + x94)
            ...
            T(i, 24) = x172 * (4290.0d0 * x149 + x158 + x161 - x162 * x73 + x163 * x2 * x73 + x164 + x169 + x171 + 4290.0d0 * &
&x71 - 1716.0d0 * x75 + x94)
            T(i, 25) = x177 * zi * (x107 + x132 + x173 * x95 + x175 + x176 - 234.0d0 * x5 + x87)
            T(i, 26) = x172 * (x1 * x110 * x163 - 1716.0d0 * x103 - x110 * x162 + x168 + x171 + x178 + x180 + 4290.0d0 * x181 &
&+ x184 + x92 + 4290.0d0 * x93)
            ...
            T(i, 39) = x18 * (x101 + x161 - x166 * x74 + x178 - x2 * x229 - x217 * x90 + x217 * x96 + 143.0d0 * x223 - x228 * &
&x90 + x230 + x231 + x79)
            T(i, 40) = x37 * (x140 + x199 + x202 - x232 * x68 - 221.0d0 * x233 + x234)
            T(i, 41) = x172 * (x0 * x163 * x236 - x162 * x236 + x169 - 1716.0d0 * x170 + x184 + x230 + 4290.0d0 * x233 + x235 &
&+ 4290.0d0 * x237 + x81 + x89)
...
& x235 + x241 + x97)
            ...
            T(i, 48) = x209 * (44.0d0 * x170 * (x119 - 182.0d0 * x80 + 35.0d0) + 2.0d0 * x80 * (-x119 - 1092.0d0 * x170 + 1560&
&.0d0 * x233 + 182.0d0 * x80 + 140.0d0 * x98 - 35.0d0) + (x105 - 1.0d0) * (-1001.0d0 * x154 + 715.0d0 * x223 + 385.0d0 * x80 - &
&35.0d0))
            T(i, 49) = 2835.0d0 * x206 * (54.0d0 * x100 * x80 * (x78 - 110.0d0 * x80 + 15.0d0) + x248 * (-858.0d0 * x154 - 132&
&0.0d0 * x170 + 2860.0d0 * x233 + 495.0d0 * x80 + 90.0d0 * x98 - 45.0d0) + 11.0d0 * x252 * (x153 - 495.0d0 * x154 + 135.0d0 * x&
&80 - 5.0d0) + 54.0d0 * x80 * (-660.0d0 * x170 + 1144.0d0 * x233 + x79 + 110.0d0 * x80 + 60.0d0 * x98 - 15.0d0))
            T(i, 50) = 2835.0d0 * x255 * (72.0d0 * x100 * x80 * (-x102 + 66.0d0 * x170 - 20.0d0 * x98 + 5.0d0) + 528.0d0 * x17&
&0 * x252 * (x102 - 5.0d0) + 288.0d0 * x170 * (88.0d0 * x170 - x178 - 20.0d0 * x98 + 10.0d0) + x248 * (-528.0d0 * x170 + x178 -&
& 160.0d0 * x186 + 880.0d0 * x237 + 120.0d0 * x98 - 10.0d0) + 33.0d0 * (33.0d0 * x154 - 30.0d0 * x80 + 5.0d0) * (x185 + 65.0d0 &
&* x186 + 1.0d0))
            T(i, 51) = x267 * (33.0d0 * x187 * (21.0d0 * x154 - 14.0d0 * x80 + 1.0d0) + 84.0d0 * x257 * (3.0d0 * x80 - 1.0d0) &
&+ 112.0d0 * x258 * x80 * (24.0d0 * x170 - x260 - 9.0d0 * x80 + 2.0d0) + 168.0d0 * x262 * x80 * (18.0d0 * x170 - x260 - 3.0d0 *&
& x80 + 1.0d0) + x266 * (-144.0d0 * x170 - 32.0d0 * x186 + 240.0d0 * x237 + x265 + 9.0d0 * x80 - 2.0d0) + 32.0d0 * x80 * (-120.&
&0d0 * x170 + 144.0d0 * x237 + x263 - x264 + 18.0d0 * x80 - 3.0d0))
            T(i, 52) = 4725.0d0 * x255 * (924.0d0 * x170 * x187 + 672.0d0 * x170 * x262 * x269 + 224.0d0 * x170 * x268 + x257 &
                                         &* x271 + x258 * x266 * x272 + 16.0d0 * x270 + 33.0d0 * (7.0d0 * x80 - 3.0d0) * (x129 - x143 + x242 - 1.0d0))
            T(i, 53) = x267 * (210.0d0 * x241 * x80 + 80.0d0 * x268 * x80 * (7.0d0 * x98 - 1.0d0) + 280.0d0 * x269 * x80 * (33&
&.0d0 * x186 - 18.0d0 * x98 + 1.0d0) + 80.0d0 * x270 + x271 * x80 * (x112 - 110.0d0 * x98 + 15.0d0) + 280.0d0 * x272 * x80 * (3&
&.0d0 * x98 - 1.0d0) + 128.0d0 * x80 * (-24.0d0 * x186 + 16.0d0 * x240 + 10.0d0 * x98 - 1.0d0) + 33.0d0 * (5.0d0 * x80 - 1.0d0)&
& * (x242 - x243 + x60 - 7.0d0))
            ...
            T(i, 61) = x37 * (x116 + x119 + x143 + x145 + 1300.0d0 * x170 - 2210.0d0 * x233 + x236 * x42 - 2210.0d0 * x237 + 1&
&5.0d0)
    ...
    subroutine T11(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 1) = -x19 * (218790.0d0 * x11 - 230945.0d0 * x14 + 88179.0d0 * x16 + 15015.0d0 * x5 - 90090.0d0 * x8 - 693.0d&
&0)
            T(i, 2) = -x21 * yi
            T(i, 3) = -x21 * zi
            ...
            T(i, 23) = -x173 * (6783.0d0 * x111 + 255.0d0 * x113 - 3230.0d0 * x168 + x172 - 3230.0d0 * x65 + 1700.0d0 * x68 - &
&150.0d0 * x70)
            T(i, 24) = -x19 * (2210.0d0 * x168 + x175 + x179 + x181 + x185 + 1326.0d0 * x65 + 663.0d0 * x88)
            T(i, 25) = -x173 * (255.0d0 * x141 + x187 + x188 - 90.0d0 * x5 - 969.0d0 * x65 + 153.0d0 * x8 - 969.0d0 * x88 + 67&
&83.0d0 * x90)
            T(i, 26) = -x19 * (x145 + x179 + x190 + 2210.0d0 * x191 + x192 + x194 + 663.0d0 * x65 + 1326.0d0 * x88)
            T(i, 27) = -x173 * (-150.0d0 * x100 + 1700.0d0 * x102 + 255.0d0 * x150 + 6783.0d0 * x154 + x172 - 3230.0d0 * x191 &
&- 3230.0d0 * x88)
            ...
            T(i, 32) = -x215 * zi * (x120 + x121 + x126 + x148 + x174 * x214 + x177 + x184 + x206 + 1105.0d0 * x208 + x209 - 2&
&340.0d0 * x68 + 1105.0d0 * x88)
            T(i, 33) = -x215 * yi * (-2340.0d0 * x102 + x121 + x139 + x153 + x155 + x189 * x214 + x194 + x210 + x216 + 1105.0d&
&0 * x217 + 1105.0d0 * x65)
            ...
            T(i, 40) = -x173 * (255.0d0 * x102 + 153.0d0 * x113 - 969.0d0 * x168 + x187 - 969.0d0 * x208 + 6783.0d0 * x243 + x&
&245 - 90.0d0 * x70)
            T(i, 41) = -x215 * xi * (-2340.0d0 * x141 + 1105.0d0 * x168 + x185 + 1105.0d0 * x191 + 6630.0d0 * x208 + x213 * x2&
&48 + 6630.0d0 * x217 + x238 - 20995.0d0 * x247 + x249)
            T(i, 42) = -x173 * (153.0d0 * x150 + x186 + x188 - 969.0d0 * x191 - 969.0d0 * x217 + x245 - x250 + 6783.0d0 * x251&
& + 255.0d0 * x68 + 9.0d0)
...
&)
            T(i, 58) = -x19 * (176.0d0 * x141 * x200 + x288 * (-28.0d0 * x100 + 546.0d0 * x141 + x197 - x199 - 2184.0d0 * x208&
& + 2210.0d0 * x290 - x45 + 7.0d0) + x289 * (2002.0d0 * x113 - 4004.0d0 * x232 + 2431.0d0 * x285 - 308.0d0 * x70 + 7.0d0))
            T(i, 59) = -93555.0d0 * x38 * (x288 * (70.0d0 * x100 - 390.0d0 * x113 - 728.0d0 * x141 + 1300.0d0 * x208 + 273.0d0&
& * x70 - 35.0d0) + 22.0d0 * x289 * x70 * (x114 - x71 + 35.0d0) + 22.0d0 * x70 * (140.0d0 * x100 + x115 - 1092.0d0 * x141 + 156&
&0.0d0 * x208 + x71 - 35.0d0) + 13.0d0 * (5.0d0 * x100 - 1.0d0) * (-1001.0d0 * x113 + 715.0d0 * x232 + 385.0d0 * x70 - 35.0d0))
            T(i, 60) = -8505.0d0 * x301 * (x141 * x294 * (143.0d0 * x113 - 110.0d0 * x70 + 15.0d0) + 96.0d0 * x141 * (-858.0d0&
& * x113 - 1320.0d0 * x141 + 2860.0d0 * x208 + x250 + 495.0d0 * x70 - 45.0d0) + x288 * (-180.0d0 * x100 + 286.0d0 * x113 - 5720&
&.0d0 * x208 - 4400.0d0 * x217 + 11440.0d0 * x247 + x299 + x300 - 165.0d0 * x70 + 15.0d0) + 11.0d0 * x296 * (-495.0d0 * x113 + &
&429.0d0 * x232 + 135.0d0 * x70 - 5.0d0) + 36.0d0 * x298 * (60.0d0 * x100 - 143.0d0 * x113 - 660.0d0 * x141 + 1144.0d0 * x208 +&
& 110.0d0 * x70 - 15.0d0))
            T(i, 61) = -14175.0d0 * x38 * (x294 * x70 * (-20.0d0 * x100 + 66.0d0 * x141 - 11.0d0 * x70 + 5.0d0) + 396.0d0 * x2&
&96 * x70 * (11.0d0 * x70 - 5.0d0) + 144.0d0 * x298 * (-20.0d0 * x100 + 88.0d0 * x141 - 33.0d0 * x70 + 10.0d0) + x308 * (80.0d0&
& * x100 - 440.0d0 * x141 + 528.0d0 * x217 + x307 + 66.0d0 * x70 - 15.0d0) + 72.0d0 * x70 * (120.0d0 * x100 - 528.0d0 * x141 - &
&160.0d0 * x150 + 880.0d0 * x217 + 33.0d0 * x70 - 10.0d0) + 429.0d0 * (33.0d0 * x113 - 30.0d0 * x70 + 5.0d0) * (17.0d0 * x150 -&
& x303 + 1.0d0))
            T(i, 62) = -14175.0d0 * x301 * (1848.0d0 * x141 * x309 * (3.0d0 * x70 - 1.0d0) + 672.0d0 * x141 * x311 * (24.0d0 *&
& x141 - x313 - 9.0d0 * x70 + 2.0d0) + 448.0d0 * x141 * (-120.0d0 * x141 + 144.0d0 * x217 + x317 - x318 + 18.0d0 * x70 - 3.0d0)&
& + 33.0d0 * x221 * (21.0d0 * x113 - 14.0d0 * x70 + 1.0d0) + x308 * (180.0d0 * x141 - 720.0d0 * x217 + x306 - x320 - x321 + 672&
&.0d0 * x322 - 6.0d0 * x70 + 1.0d0) + 84.0d0 * x316 * (18.0d0 * x141 - x313 - 3.0d0 * x70 + 1.0d0) + 56.0d0 * x319 * x70 * (-14&
&4.0d0 * x141 - 32.0d0 * x150 + 240.0d0 * x217 + x320 + 9.0d0 * x70 - 2.0d0))
            T(i, 63) = -4725.0d0 * x38 * (3234.0d0 * x221 * x70 + 3234.0d0 * x309 * x328 * x70 + 1176.0d0 * x311 * x330 + 1176&
&.0d0 * x316 * x327 + 784.0d0 * x319 * x329 * x70 + 896.0d0 * x323 * x70 + 784.0d0 * x324 * x70 + 429.0d0 * (7.0d0 * x70 - 3.0d&
&0) * (x259 + x260 - x261 - 7.0d0))
            T(i, 64) = -4725.0d0 * x301 * (5120.0d0 * x141 * x323 + 1344.0d0 * x141 * x327 * (-110.0d0 * x100 + x315 + 15.0d0)&
& + 4480.0d0 * x141 * x329 * (3.0d0 * x100 - 1.0d0) + x224 * x300 + 320.0d0 * x324 * x70 * (7.0d0 * x100 - 1.0d0) + 840.0d0 * x&
&328 * x70 * (33.0d0 * x100 + 143.0d0 * x257 - x315 - 1.0d0) + 560.0d0 * x330 * (-18.0d0 * x100 + 33.0d0 * x150 + 1.0d0) + 128.&
&0d0 * x70 * (-40.0d0 * x100 - 448.0d0 * x257 + x299 + 256.0d0 * x331 + 1.0d0) + 33.0d0 * (5.0d0 * x70 - 1.0d0) * (x279 + x281 &
&- x282 - x283 + 7.0d0))
            T(i, 65) = -x39 * (-420.0d0 * x100 + 2142.0d0 * x150 - 3876.0d0 * x257 + 2261.0d0 * x331 + 21.0d0)
            T(i, 66) = -x333 * x82
            T(i, 67) = -x53 * (-90090.0d0 * x113 + 218790.0d0 * x232 - 230945.0d0 * x285 + x286 * x29 + 15015.0d0 * x70 - 693.&
&0d0)
            T(i, 68) = -x129 * x287
            ...
            T(i, 77) = -x160 * x333
            T(i, 78) = -x56 * (15015.0d0 * x100 - 90090.0d0 * x150 + 218790.0d0 * x257 + x29 * x332 - 230945.0d0 * x331 - 693.&
&0d0)
        end do
    end subroutine T11
    subroutine T12(x, y, z, T)
        ...
        do concurrent(i=1:size(x))
            ...
            T(i, 1) = x21 * (-1021020.0d0 * x11 + 2078505.0d0 * x14 - 1939938.0d0 * x17 + x19 * xi**12 - 18018.0d0 * x5 + 2252&
&25.0d0 * x8 + 231.0d0)
            T(i, 2) = x23 * x25
            T(i, 3) = x25 * x26
            ...
            T(i, 11) = x21 * (235144.0d0 * x53 - x67 * x73 + x67 * x74 - x68 * x69 - 176358.0d0 * x70 - 92820.0d0 * x71 + x79 &
&+ x83 + x84)
            T(i, 12) = x43 * (-9044.0d0 * x53 + 7429.0d0 * x70 + x85 + x86 + x87 + x88)
            T(i, 13) = x107 * (x103 + x106 + x2 * x36 * x81 + x30 * x96 + 117572.0d0 * x46 + 117572.0d0 * x53 - 88179.0d0 * x7&
&0 - 46410.0d0 * x71 + x84 - 88179.0d0 * x89 - 46410.0d0 * x90 + 1365.0d0 * x92 - x93 * x94 + x99)
            T(i, 14) = x43 * (x108 + x109 + x110 - 9044.0d0 * x46 + x88 + 7429.0d0 * x89)
            T(i, 15) = x21 * (-x111 * x73 + x111 * x74 - x112 * x69 + x113 + x114 + 235144.0d0 * x46 + x84 - 176358.0d0 * x89 &
&- 92820.0d0 * x90)
            ...
            T(i, 22) = x21 * (-x155 * x157 - x155 * x68 + x156 * x160 + x156 * x162 - 49725.0d0 * x158 + 314925.0d0 * x161 + x&
&163 + x167 + 62985.0d0 * x53 - 49725.0d0 * x71 + 8775.0d0 * x80)
...
&398.0d0 * x53)
            T(i, 25) = x172 * (969.0d0 * x11 + x133 + x142 - 33915.0d0 * x189 + x191 + x192 + x196 + x198 + 135.0d0 * x5 - 765&
&.0d0 * x8 - 85.0d0 * x92)
...
&x211 + 8398.0d0 * x46)
            ...
            T(i, 28) = x21 * (8775.0d0 * x100 - x112 * x155 - x155 * x217 + x160 * x216 + x162 * x216 + x163 - 49725.0d0 * x19&
&9 + 314925.0d0 * x204 + x218 + 62985.0d0 * x46 - 49725.0d0 * x90)
            ...
            T(i, 37) = x21 * (-x157 * x69 - 92820.0d0 * x158 - x188 * x270 + x269 * x272 + 235144.0d0 * x271 + x273 + x276 - 3&
&0940.0d0 * x71 + x83)
            T(i, 38) = x172 * (x127 + 13566.0d0 * x158 + x219 + x225 - 13566.0d0 * x271 + x277 + x279 - 7.0d0)
            T(i, 39) = x21 * (-x157 * x173 + x157 * x177 - x164 * x280 + x175 * x281 + x182 + x186 + x203 + 8398.0d0 * x271 + &
&x283 + x285 + x286 + x291)
            T(i, 40) = x172 * (1938.0d0 * x158 + x222 * x280 + x238 + x241 + x249 + 323.0d0 * x282 + x292 + x294)
            T(i, 41) = 93555.0d0 * x20 * (2340.0d0 * x100 - 79560.0d0 * x101 - 78.0d0 * x104 - 881790.0d0 * x16 * x232 - 88179&
&0.0d0 * x16 * x299 - x16 * x300 * x6 + 3380195.0d0 * x18 * x298 * x6 + x183 + 251940.0d0 * x189 + x206 + x285 + 251940.0d0 * x&
&290 + x296 + 251940.0d0 * x301 + x303 + x306 - 78.0d0 * x5 - 78.0d0 * x75 + 2340.0d0 * x80 + 2340.0d0 * x92 + 3.0d0)
...
& + 8398.0d0 * x312 + x316)
            ...
            T(i, 45) = x21 * (x113 - x188 * x320 - 92820.0d0 * x199 - x217 * x69 + x272 * x319 + x273 + 235144.0d0 * x312 + x3&
&21 - 30940.0d0 * x90)
            T(i, 46) = x58 * (x323 + x325 + x50)
            T(i, 47) = x26 * x328 * (-510.0d0 * x166 + x236 + x270 * x326 - 9044.0d0 * x271 + 1292.0d0 * x275 - 969.0d0 * x324&
& + x327 + 60.0d0 * x75 + x85)
            T(i, 48) = x58 * (x138 + 2261.0d0 * x158 - 2261.0d0 * x271 + 6783.0d0 * x282 + x332 + x333 + x334)
            T(i, 49) = x61 * (-85.0d0 * x100 - 765.0d0 * x166 + x168 + x196 + x231 + 969.0d0 * x275 - 33915.0d0 * x290 + x332 &
&+ x335 + x336 + x338)
            ...
            T(i, 52) = x58 * (135.0d0 * x104 + x193 + x198 - 765.0d0 * x208 + x213 + x261 - 33915.0d0 * x301 + 969.0d0 * x313 &
&+ x338 + x344 + x346 - 85.0d0 * x80 - 3.0d0)
            ...
            T(i, 58) = x107 * (1365.0d0 * x100 + x102 + x106 - 46410.0d0 * x158 - x270 * x369 + x270 * x96 + 117572.0d0 * x271&
& + x276 - x281 * x372 - 46410.0d0 * x282 + 881790.0d0 * x290 - x369 * x370 + 117572.0d0 * x371 + x373 + 7.0d0)
...
& + 8398.0d0 * x371 + x377)
            T(i, 61) = 2027025.0d0 * x42 * (x168 + x213 + x233 * x299 + x242 + x245 + x263 + x341 + x343 + x41 - 1700.0d0 * x9&
&2 - 15.0d0)
            T(i, 62) = x21 * (-x173 * x378 + x187 + x200 + x216 * x376 + x283 + x296 + x302 + x305 + x316 + x358 * x378 - x375&
                             & * x67 + x377 + 8398.0d0 * x379)
            T(i, 63) = x172 * (x139 + x141 + 6783.0d0 * x199 + 2261.0d0 * x295 + x344 + x345 + x347 - 2261.0d0 * x379)
            T(i, 64) = x107 * (x1 * x320 * x95 + x103 + x159 * x300 - 46410.0d0 * x199 - 46410.0d0 * x295 - x311 * x372 + 1175&
&72.0d0 * x312 - x320 * x369 + x321 - x369 * x380 + x373 + 117572.0d0 * x379 + 1365.0d0 * x80 + x98)
            ...
            T(i, 69) = x247 * (x390 * (-84.0d0 * x104 + 459.0d0 * x166 - x278 - 3672.0d0 * x282 + 3230.0d0 * x371 - 189.0d0 * &
&x75 + 1134.0d0 * x92 + 21.0d0) + 208.0d0 * x92 * (-459.0d0 * x166 + x278 + 189.0d0 * x75 - 21.0d0) + (x194 - 1.0d0) * (4914.0d&
&0 * x166 + x274 - 7956.0d0 * x275 - 1092.0d0 * x75 + 63.0d0))
            T(i, 70) = 467775.0d0 * x397 * (13.0d0 * x110 * (2002.0d0 * x166 - 4004.0d0 * x275 + 2431.0d0 * x324 - 308.0d0 * x&
&75 + 7.0d0) + 88.0d0 * x391 * x75 * (-273.0d0 * x166 + x287 + x97 - 7.0d0) + x396 * (-28.0d0 * x104 + x165 + 1092.0d0 * x166 -&
& 3640.0d0 * x282 + x29 + 4420.0d0 * x371 + x395 + 14.0d0) + 88.0d0 * x75 * (-28.0d0 * x104 + 273.0d0 * x166 - 2184.0d0 * x282 &
&+ x288 + 2210.0d0 * x371 + 546.0d0 * x92 + x99))
            T(i, 71) = 93555.0d0 * x400 * (1144.0d0 * x110 * x92 * (x284 + x77 + 35.0d0) + x390 * (390.0d0 * x166 + 560.0d0 * &
&x208 - 7800.0d0 * x282 + x29 - 7280.0d0 * x295 + 15600.0d0 * x304 + x399 + 4368.0d0 * x92 + 35.0d0) + 44.0d0 * x391 * x75 * (1&
&40.0d0 * x104 + 1560.0d0 * x282 - x284 + x76 - 1092.0d0 * x92 - 35.0d0) + 352.0d0 * x92 * (70.0d0 * x104 - 390.0d0 * x166 + x2&
&8 + 1300.0d0 * x282 - x395 - 35.0d0) + 13.0d0 * (x212 - x308 + 1.0d0) * (-1001.0d0 * x166 + 715.0d0 * x275 + 385.0d0 * x75 - 3&
&5.0d0))
            T(i, 72) = x412 * (x396 * (-240.0d0 * x104 + 1430.0d0 * x166 - 11440.0d0 * x282 - 5280.0d0 * x295 + 16016.0d0 * x3&
&04 + x410 - 660.0d0 * x75 + 4400.0d0 * x92 + 45.0d0) + 198.0d0 * x403 * (143.0d0 * x166 - 110.0d0 * x75 + 15.0d0) + 143.0d0 * &
&x405 * (-495.0d0 * x166 + 429.0d0 * x275 + x335 - 5.0d0) + 48.0d0 * x407 * x75 * (-858.0d0 * x166 + x259 + 2860.0d0 * x282 + 4&
&95.0d0 * x75 - 1320.0d0 * x92 - 45.0d0) + 132.0d0 * x408 * x75 * (-143.0d0 * x166 + 1144.0d0 * x282 + x348 - x409 + 110.0d0 * &
&x75 - 15.0d0) + x411 * (-180.0d0 * x104 + 286.0d0 * x166 - 5720.0d0 * x282 - 4400.0d0 * x295 + 11440.0d0 * x304 + x410 - 165.0&
&d0 * x75 + 2640.0d0 * x92 + 15.0d0))
            T(i, 73) = 42525.0d0 * x400 * (396.0d0 * x403 * (x415 - 11.0d0 * x75 + 66.0d0 * x92 + 5.0d0) + 10296.0d0 * x405 * &
&x92 * (11.0d0 * x75 - 5.0d0) + x407 * x411 * (120.0d0 * x104 - 160.0d0 * x208 + 880.0d0 * x295 + 33.0d0 * x75 - 528.0d0 * x92 &
&- 10.0d0) + 1056.0d0 * x408 * x92 * (x415 - 33.0d0 * x75 + 88.0d0 * x92 + 10.0d0) + 32.0d0 * x75 * (-120.0d0 * x104 + 400.0d0 &
&* x208 - 2640.0d0 * x295 - 320.0d0 * x313 + 2464.0d0 * x379 + x409 - 22.0d0 * x75 + 5.0d0) + 576.0d0 * x92 * (528.0d0 * x295 +&
& x416 + x418 + 66.0d0 * x75 - 440.0d0 * x92 - 15.0d0) + 143.0d0 * (33.0d0 * x166 - x293 + 5.0d0) * (45.0d0 * x104 + x252 + x31&
&7 - 1.0d0))
            T(i, 74) = 14175.0d0 * x397 * (429.0d0 * x318 * (21.0d0 * x166 - 14.0d0 * x75 + 1.0d0) + 6468.0d0 * x421 * x75 * (&
&3.0d0 * x75 - 1.0d0) + 6468.0d0 * x423 * x75 * (-x424 - 3.0d0 * x75 + 18.0d0 * x92 + 1.0d0) + 1176.0d0 * x427 * x75 * (-x424 -&
& 9.0d0 * x75 + 24.0d0 * x92 + 2.0d0) + 1568.0d0 * x430 * x75 * (144.0d0 * x295 + x431 - x432 + 18.0d0 * x75 - 120.0d0 * x92 - &
&3.0d0) + 1176.0d0 * x434 * x75 * (-32.0d0 * x208 + 240.0d0 * x295 + x435 + 9.0d0 * x75 - 144.0d0 * x92 - 2.0d0) + 896.0d0 * x7&
&5 * (-x197 + 48.0d0 * x208 - 504.0d0 * x295 - 32.0d0 * x313 + 384.0d0 * x379 + x415 + 180.0d0 * x92 + 2.0d0) + 1568.0d0 * x75 &
&* (-720.0d0 * x295 + 672.0d0 * x379 + x417 - x435 - x437 - 6.0d0 * x75 + 180.0d0 * x92 + 1.0d0))
            T(i, 75) = 33075.0d0 * x400 * (6864.0d0 * x318 * x92 + 1848.0d0 * x421 * x443 + 14784.0d0 * x423 * x439 * x92 + x4&
&27 * x445 + 448.0d0 * x430 * x444 + 2688.0d0 * x434 * x440 * x92 + 7168.0d0 * x438 * x92 + 128.0d0 * x442 + 429.0d0 * (7.0d0 *&
& x75 - 3.0d0) * (-x348 + x350 + x351 - x352 + 1.0d0))
            T(i, 76) = x412 * (330.0d0 * x321 * x75 + 2560.0d0 * x438 * x75 * (7.0d0 * x104 - 1.0d0) + 3360.0d0 * x439 * x75 *&
& (33.0d0 * x104 + 143.0d0 * x313 - x426 - 1.0d0) + 1120.0d0 * x440 * x75 * (-18.0d0 * x104 + 33.0d0 * x208 + 1.0d0) + 640.0d0 &
&* x442 + 1320.0d0 * x443 * (x105 - 273.0d0 * x208 + x314 - 7.0d0) + 2240.0d0 * x444 * (3.0d0 * x104 - 1.0d0) + x445 * (-110.0d&
&0 * x104 + x426 + 15.0d0) + 256.0d0 * x75 * (336.0d0 * x208 - 512.0d0 * x313 - x416 + x441 + 5.0d0) + 143.0d0 * x87 * (x381 + &
&x382 - x384 + x399 + 21.0d0))
            T(i, 77) = x353 * (-2550.0d0 * x208 + x234 + 9690.0d0 * x313 - 14535.0d0 * x349 + 7429.0d0 * x446 - 3.0d0)
            T(i, 78) = x447 * x61
            T(i, 79) = x21 * (-1939938.0d0 * x16 * x357 + 225225.0d0 * x166 + x19 * yi**12 - 1021020.0d0 * x275 + 2078505.0d0 &
                             &* x324 - 18018.0d0 * x75 + 231.0d0)
            T(i, 80) = x172 * x387
            ...
            T(i, 83) = x21 * (x111 * x19 * x269 + x114 - x188 * x370 + x276 - 92820.0d0 * x282 - 30940.0d0 * x295 + 235144.0d0&
                             & * x371 - x374 * x69 + x450)
            T(i, 84) = x172 * (x149 + x153 + x223 + x227 + 22610.0d0 * x282 + 11305.0d0 * x295 - 22610.0d0 * x371 + x374 * x55&
& + x451)
            T(i, 85) = x21 * (-x155 * x374 - x155 * x378 + x156 * x19 * x216 + x167 + x218 - 49725.0d0 * x282 - 49725.0d0 * x2&
&95 + 314925.0d0 * x304 + 62985.0d0 * x371 + 62985.0d0 * x379 + 8775.0d0 * x92 + 5.0d0)
            T(i, 86) = x172 * (x125 + x264 + x268 + 11305.0d0 * x282 + 22610.0d0 * x295 + x378 * x55 - 22610.0d0 * x379 + x451&
&)
            T(i, 87) = x21 * (-x188 * x380 + x19 * x319 * x67 - 30940.0d0 * x282 - 92820.0d0 * x295 + x321 - x378 * x69 + 2351&
&44.0d0 * x379 + x450 + x79)
            ...
            T(i, 90) = x172 * x447
            T(i, 91) = x21 * (-18018.0d0 * x104 + x19 * zi**12 + 225225.0d0 * x208 - 1021020.0d0 * x313 + 2078505.0d0 * x349 -&
& 1939938.0d0 * x446 + 231.0d0)
        end do
    end subroutine T12
end module T_tensor
